        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in">
          <div className="bg-[#0a0a0a] border border-zinc-800 rounded-[2rem] w-[90%] max-w-lg overflow-hidden relative shadow-2xl">
            ...
            <div className="p-8 space-y-6">
                ...
                <div className="bg-zinc-900/50 rounded-xl p-4 border border-zinc-800 hover:border-green-500/30 transition-colors"><div className="flex items-center gap-2 mb-2 text-zinc-300 font-bold uppercase text-xs tracking-wider"><Mail size={14} /> {t.modals.contactTitle}</div><a href="mailto:info@digitrikpro.com" className="text-green-400 hover:text-green-300 font-mono text-sm block">info@digitrikpro.com</a></div>
